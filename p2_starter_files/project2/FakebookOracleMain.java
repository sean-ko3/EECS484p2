...
public final class FakebookOracleMain {
    // Member Variables
    private static String username = "seanko"; // replace with your uniqname
    private static String password = "seankoeecs484"; // replace with your Oracle password (default: eecsclass)
